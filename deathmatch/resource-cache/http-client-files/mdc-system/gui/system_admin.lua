...
function system_admin ( users, count )
	...
	window.userCol		= guiGridListAddColumn( window.usersTable, "User", 0.7 )
	...
	for i = 1, count - 1, 1 do
		...
		guiGridListSetItemText ( window.usersTable, window.usersRows[ i ], window.levelCol, ( tonumber( users[ i ][ 3 ] ) == 1 and "Regular" or "Admin" ), false, false )
