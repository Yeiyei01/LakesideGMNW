...
function createEditValueWindow( key )
  ...
  advlook_editvalue_window = guiCreateWindow( 349, 300, 285, 105, "Edita tus looks - " .. stuff.name, false )
  guiWindowSetSizable( advlook_editvalue_window, false )
  
  guiCreateLabel(11, 26, 258, 16, "Ahora está editando su " .. stuff.name .. ".", false, advlook_editvalue_window)
  
  local edit = guiCreateEdit(12, 46, 250, 22, tostring( stuff.value ),false,advlook_editvalue_window)
  
  
  local save = guiCreateButton(15,72,123,21,"Guardar",false,advlook_editvalue_window)
