...
function F1RPhelp( key, keyState )
	...
	if not myWindow then
		...
		myWindow = guiCreateWindow ( 0, 0, 800, 600, "Lakeside RP - Centro de Ayuda", false )
		...
		local tabRules = guiCreateTab( "Normativa", tabPanel )
		...
		local tabOverview = guiCreateTab( "Normativa", tabPanel )
		...
		local tabMantis = guiCreateTab( "-", tabPanel )
