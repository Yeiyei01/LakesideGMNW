...
local staticBlips = {}
local staticPoints = {
	["loadupBlip"] = { 106.302734375, -285.890625, 0.6, 0 , 0},
	["loadupEntrance1"] = { 106.302734375, -285.890625, 0.6, 0, 0},
	["loadupEntrance2"] = { 63.5615234375, -284.97265625, 1.6979444026947, 0, 0},
	["loadup1"] = { 1541.890625, 1587.3056640625, 10.938200950623, 0, 66},
	["loadup2"] = { 1531.7646484375, 1586.890625, 10.937031745911, 0, 66},
...
function enteringRSHaulWarehouse1(thePlayer)
	-- if getElementData(thePlayer, "account:username") ~= "Alejandro" then
...
function spawnFinishMarkerTruckJob()
	if not endmarker then
		endblip = createBlip(87.8984375 , -306.224609375, 1.578125, 0, 2, 255, 0, 0)
		
		endmarker2 = createMarker(87.8984375 , -306.224609375, 1.578125, "checkpoint", 4, 255, 0, 0, 150)
