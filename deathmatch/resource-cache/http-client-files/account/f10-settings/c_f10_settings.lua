...
function showSettingsWindow(tab)
	...
	GUIEditor_Label.graphicSettingsgeneral = guiCreateLabel(0.0222,0.0361,0.313,lineH,"Configuraciones Generales:",true,GUIEditor_Tab.graphicSettings)
	guiSetFont(GUIEditor_Label.graphicSettingsgeneral,"default-bold-small")

	GUIEditor_Checkbox.graphic_motionblur = guiCreateCheckBox(0.036,0.1005,0.2992,lineH,"Activar Desenfoque de Movimiento",false,true,GUIEditor_Tab.graphicSettings)
	...
	GUIEditor_Checkbox.graphic_skyclouds = guiCreateCheckBox(0.036,0.1005+posY,0.2992,lineH,"Activar Cielo HD",false,true,GUIEditor_Tab.graphicSettings)
	...
	GUIEditor_Checkbox.streams = guiCreateCheckBox(0.036,0.1005+posY,0.2992,lineH,"Activar Transmisión de Audio",false,true,GUIEditor_Tab.graphicSettings)
	...
	GUIEditor_Checkbox.graphic_logs = guiCreateCheckBox(0.036,0.1005+posY,0.2992,lineH,"Habilitar el Registro del Chatbox",false,true,GUIEditor_Tab.graphicSettings)
	...
	GUIEditor_Checkbox.cellphone_log = guiCreateCheckBox(0.036,0.1005+posY,0.2992,lineH,"Habilitar el Registro de llamadas y SMS",false,true,GUIEditor_Tab.graphicSettings)
	...
	GUIEditor_Checkbox.graphic_chatbub = guiCreateCheckBox(0.036,0.1005+posY,0.2992,lineH,"Activar Burbujas del Chat",false,true,GUIEditor_Tab.graphicSettings)
	...
	GUIEditor_Checkbox.graphic_chatbub_square = guiCreateCheckBox(0.036,0.1005+posY,0.2992,lineH,"Activar Cuadros de Burbujas del Chat",false,true,GUIEditor_Tab.graphicSettings)
	...
	GUIEditor_Checkbox.graphic_typingicon = guiCreateCheckBox(0.036,0.1005+posY,0.2992,lineH,"Activar Icons del Chat",false,true,GUIEditor_Tab.graphicSettings)
	if getResourceFromName("chat-system") then
	...
	GUIEditor_Checkbox.settings_hud_style = guiCreateCheckBox(0.036,0.1005+posY,0.2992,lineH,"Activar el Nuevo HUD",false,true,GUIEditor_Tab.graphicSettings)
	if getResourceFromName("hud") then
	...
	GUIEditor_Checkbox.graphic_shaderradar = guiCreateCheckBox(0.036,0.1005+posY,0.2992,lineH,"Activar Radar HD",false,true,GUIEditor_Tab.graphicSettings)
	...
	GUIEditor_Checkbox.graphic_shaderwater = guiCreateCheckBox(0.036,0.1005+posY,0.2992,lineH,"Activar Agua HD",false,true,GUIEditor_Tab.graphicSettings)
	...
	GUIEditor_Checkbox.graphic_shaderveh = guiCreateCheckBox(0.036,0.1005+posY,0.2992,lineH,"Activar Vehiculos HD",false,true,GUIEditor_Tab.graphicSettings)
	...
	GUIEditor_Checkbox.vehicle_hotkey = guiCreateCheckBox(0.036,0.1005+posY,0.2992,lineH,"Activar los Binds del Vehiculo",false,true,GUIEditor_Tab.graphicSettings)
	...
	GUIEditor_Checkbox.autopark = guiCreateCheckBox(0.036,0.1005+posY,0.2992,lineH,"Activar el autopark /park",false,true,GUIEditor_Tab.graphicSettings)
	if getResourceFromName('vehicle') then
	...
	GUIEditor_Checkbox.vehicle_rims = guiCreateCheckBox(0.0222+posX,posY,0.313,lineH,"Habilitar Llantas Personalizados",false,true,GUIEditor_Tab.graphicSettings)
	...
	posY = posY + lineH
	GUIEditor_Checkbox.phone_anim = guiCreateCheckBox(0.0222+posX,posY,0.313,lineH,"Activar Animación del Teléfono",false,true,GUIEditor_Tab.graphicSettings)
	...
	posY = posY + lineH
	GUIEditor_Checkbox.talk_anim = guiCreateCheckBox(0.0222+posX,posY,0.313,lineH,"Activar Animaciones al Hablar",false,true,GUIEditor_Tab.graphicSettings)
	...
	posY = posY + lineH
	GUIEditor_Checkbox.pm_username = guiCreateCheckBox(0.0222+posX,posY,0.313,lineH,"Mostrar tu Nombre en /pm.",false,true,GUIEditor_Tab.graphicSettings)
	...
	posY = posY + lineH
	GUIEditor_Checkbox.weapon_show_selector = guiCreateCheckBox(0.0222+posX,posY,0.313,lineH,"Mostrar Selector Armas mientras se usa.",false,true,GUIEditor_Tab.graphicSettings)
	...
	posY = posY + lineH
	GUIEditor_Checkbox.bind_indicators = guiCreateCheckBox(0.0222+posX,posY,0.313,lineH,"Habilitar Indicadores reenganchables.",false,true,GUIEditor_Tab.graphicSettings)
	...
	GUIEditor_Checkbox.dynamic_lighting = guiCreateCheckBox(0.0222+posX,posY,0.313,lineH,"Activar Iluminación Dinámica.",false,true,GUIEditor_Tab.graphicSettings)
	...
	if snowfall then
		posY = posY + lineH
		GUIEditor_Checkbox.snowfall = guiCreateCheckBox(0.0222+posX,posY,0.313,lineH,"Habilitar Nevada.",false,true,GUIEditor_Tab.graphicSettings)
	...
	if xmas then
		posY = posY + lineH
		GUIEditor_Checkbox.xmastreefx = guiCreateCheckBox(0.0222+posX,posY,0.313,lineH,"Habilitar Arbol de Navidad FX.",false,true,GUIEditor_Tab.graphicSettings)
	...
	posY = posY + lineH
	GUIEditor_Checkbox.punishment_notification_selector = guiCreateCheckBox(0.0222+posX,posY,0.313,lineH,"Ocultar Notificaciones Sanciones Staff.",false,true,GUIEditor_Tab.graphicSettings)
	...
	if exports.integration:isPlayerSupporter(getLocalPlayer()) or exports.integration:isPlayerTrialAdmin(getLocalPlayer()) then
		posY = posY + lineH
		GUIEditor_Checkbox.auto_check = guiCreateCheckBox(0.0222+posX,posY,0.313,lineH,"Abrir Automáticamente /check en /ar",false,true,GUIEditor_Tab.graphicSettings)
	...
	posY = posY + lineH
	GUIEditor_Checkbox.enableNewUIStyle = guiCreateCheckBox(0.0222+posX,posY,0.313,lineH,"Habilitar Nuevo Estilo de Interfaz",false,true,GUIEditor_Tab.graphicSettings)
	if getResourceFromName("hud") then
	...
	if exports.integration:isPlayerStaff(localPlayer) then
		posY = posY + lineH
		GUIEditor_Checkbox.enableIncomingReport = guiCreateCheckBox(0.0222+posX,posY,0.313,lineH,"Activar Sonidos Nuevos Reportes",false,true,GUIEditor_Tab.graphicSettings)
		...
		posY = posY + lineH
		GUIEditor_Checkbox.enableIncomingPriorityReport = guiCreateCheckBox(0.0222+posX,posY,0.313,lineH,"Activar Sonidos Reportes Importantes",false,true,GUIEditor_Tab.graphicSettings)
	...
	posY = posY + lineH
	GUIEditor_Checkbox.misc_sounds = guiCreateCheckBox(0.0222+posX,posY,0.313,lineH,"Desactivar Sonidos misc del Juego Defecto",false,true,GUIEditor_Tab.graphicSettings)
	...
	posY = posY + lineH
	GUIEditor_Checkbox.vehicle_discs = guiCreateCheckBox(0.0222+posX,posY,0.413,lineH,"Ocultar Descripción Actual del Vehículo con ALTGR",false,true,GUIEditor_Tab.graphicSettings)
	...
	--GUIEditor_Checkbox.noti_settings = guiCreateButton(0.0222+posX,posY,0.313,lineH,"Configuración Notificaciones",true,GUIEditor_Tab.graphicSettings)

	-----------------------------------------------------------------------

	posX = posX + lineW2
	GUIEditor_Label.graphicSettings_desc = guiCreateLabel(0.0222+posX,0.0361,0.313,lineH,"Configuraciones de Descripciones:",true,GUIEditor_Tab.graphicSettings)
	guiSetFont(GUIEditor_Label.graphicSettings_desc,"default-bold-small")

	GUIEditor_Checkbox.enableOverlayDescription = guiCreateCheckBox(0.036+posX,0.1005,0.2992,lineH,"Alternar todas las Descripciones",false,true,GUIEditor_Tab.graphicSettings)
	...
	GUIEditor_Checkbox.noti_faction_updates = guiCreateCheckBox(0.036,0.1005,0.2992,lineH,"Actualizaciones Facciones",false,true,GUIEditor_Tab.Notifications)
	guiCheckBoxSetSelected(GUIEditor_Checkbox.noti_faction_updates,getElementData(localPlayer, "noti_faction_updates") ~= "0")

	GUIEditor_Checkbox.noti_offline_pm = guiCreateCheckBox(0.036,0.1005+posY,0.2992,lineH,"Mensajes Entrantes",false,true,GUIEditor_Tab.Notifications)
	guiCheckBoxSetSelected(GUIEditor_Checkbox.noti_offline_pm,getElementData(localPlayer, "noti_offline_pm") ~= "0")

	posY = posY + lineH
	GUIEditor_Checkbox.vehicle_inactivity_scanner = guiCreateCheckBox(0.036,0.1005+posY,0.2992,lineH,"Inactividad del Vehículo",false,true,GUIEditor_Tab.Notifications)
	...
	posY = posY + lineH
	GUIEditor_Checkbox.interior_inactivity_scanner = guiCreateCheckBox(0.036,0.1005+posY,0.2992,lineH,"Relacionados Interiores",false,true,GUIEditor_Tab.Notifications)
	...
	posY = posY + lineH
	GUIEditor_Checkbox.support_center = guiCreateCheckBox(0.036,0.1005+posY,0.2992,lineH,"Soporte",false,true,GUIEditor_Tab.Notifications)
	...
	GUIEditor_Checkbox.noti_no_noti = guiCreateCheckBox(0.036+posX,0.1005,1,lineH,"Mostrar el botón incluso cuando no hay notificaciones",false,true,GUIEditor_Tab.Notifications)
	...
	GUIEditor_Checkbox.social_classic_user_interface = guiCreateCheckBox(0.036,0.1005,0.888,lineH,"Interfaz Clásica",false,true,GUIEditor_Tab.Social)
	...
	GUIEditor_Checkbox.social_invite_only = guiCreateCheckBox(0.036,0.1005+posY,0.888,lineH,"Sólo Invitados (Ignorar solicitudes de amistad entrantes)",false,true,GUIEditor_Tab.Social)
	guiCheckBoxSetSelected(GUIEditor_Checkbox.social_invite_only,getElementData(localPlayer, "social_invite_only") == "1")

	posY = posY + lineH
	GUIEditor_Checkbox.social_friends_bypass_pmblock = guiCreateCheckBox(0.036,0.1005+posY,0.888,lineH,"Permitir que mis amigos pasen por alto mi bloqueo de PM",false,true,GUIEditor_Tab.Social)
	...
	posY = posY + lineH
	GUIEditor_Checkbox.social_friend_updates = guiCreateCheckBox(0.036,0.1005+posY,0.888,lineH,"Recibir alertas y notificaciones de amigos",false,true,GUIEditor_Tab.Social)
	guiCheckBoxSetSelected(GUIEditor_Checkbox.social_friend_updates,getElementData(localPlayer, "social_friend_updates") ~= "0")

	posY = posY + lineH
	local indent = 0.02
	GUIEditor_Checkbox.social_friend_updates_on_off = guiCreateCheckBox(0.036+indent,0.1005+posY,0.888,lineH,"Status Activo/Inactivo",false,true,GUIEditor_Tab.Social)
	...
	posY = posY + lineH
	GUIEditor_Checkbox.social_friend_updates_msg = guiCreateCheckBox(0.036+indent,0.1005+posY,0.888,lineH,"Status",false,true,GUIEditor_Tab.Social)
	...
	posY = posY + lineH
	GUIEditor_Checkbox.social_friend_updates_char = guiCreateCheckBox(0.036+indent,0.1005+posY,0.888,lineH,"Cambios Personaje",false,true,GUIEditor_Tab.Social)
	...
	posY = posY + lineH
	GUIEditor_Checkbox.social_friend_updates_sound = guiCreateCheckBox(0.036+indent,0.1005+posY,0.888,lineH,"Activar Efectos Sonido",false,true,GUIEditor_Tab.Social)
	...
	--GUIEditor_Label.charSettingsgeneral = guiCreateLabel(0.0222,0.0361,0.313,lineH,"Cambios Personaje:",true,GUIEditor_Tab.graphicSettings)
	...
	posY = posY + lineH
	--[[
	GUIEditor_Checkbox.graphic_motionblur = guiCreateCheckBox(0.036,0.1005,0.2992,lineH,"Habilitar Auto/Aparcamiento Vehículo",false,true,GUIEditor_Tab.graphicSettings)
	if getElementData(localPlayer, "graphic_motionblur") == "0" then
		guiCheckBoxSetSelected(GUIEditor_Checkbox.graphic_motionblur,false)
	else
		guiCheckBoxSetSelected(GUIEditor_Checkbox.graphic_motionblur,true)
