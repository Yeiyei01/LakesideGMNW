	...
	if (characterList) then
		...
		for _, v in ipairs(characterList) do
			...
			if thePed and isElement( thePed ) then
				...
				outputChatBox("[ACCOUNT] Error apareciendo el personaje '"..v[2].."'. Reportalo en el discord:" )
...
--[[
	...
	dxDrawText("Horas:", 170+mta_posxOffset, 65+mta_posyOffset, 242, 106+mta_posyOffset, tocolor(255, 255, 255, 255), 1.00, "default-bold", "left", "top", false, false, true, false, false)
	...
	dxDrawText("Fecha de Creacion:", 8+mta_posxOffset, 88+mta_posyOffset, 137, 124+mta_posyOffset, tocolor(255, 255, 255, 255), 1.00, "default-bold", "left", "top", false, false, true, false, false)
	...
	dxDrawText("Ultima vez:", 8+mta_posxOffset, 106+mta_posyOffset, 74, 144+mta_posyOffset, tocolor(255, 255, 255, 255), 1.00, "default-bold", "left", "top", false, false, true, false, false)
	...
	dxDrawText("Correo:", 8+mta_posxOffset, 125+mta_posyOffset, 113, 169+mta_posyOffset, tocolor(255, 255, 255, 255), 1.00, "default-bold", "left", "top", false, false, true, false, false)
    ...
    dxDrawText("Historial", 54+mta_posxOffset, 150+mta_posyOffset, width-54+mta_posxOffset, 183+mta_posyOffset, tocolor(255, 255, 255, 255), 1.00, "arial", "center", "top", false, false, true, false, false) -- History
    ...
    dxDrawText("Refrescar Personajes", 3+mta_posxOffset, 172+mta_posyOffset, buttonWidth+mta_posxOffset, 204+mta_posyOffset,  cooldown and cooldown>=getTickCount()-5000 and tocolor(255, 255, 255, 100) or tocolor(255, 255, 255, 255), 1.00, "arial", "center", "top", false, false, true, false, false)
    ...
    --[[if not fid then
	    ...
	    dxDrawText(fid and "Cerrar" or "Link Forum Account", width-buttonWidth+3+mta_posxOffset, 173+mta_posyOffset, buttonWidth+width/2+mta_posxOffset, 209+mta_posyOffset, tocolor(255, 255, 255, 255), 1.00, "arial", "center", "top", false, false, true, false, false) -- Link Forums account
	...
	--[[if forum_box['show'] and fid then
		...
		dxDrawText("Reputacion:", 8+mta_posxOffset, 65+mta_posyOffset, 74, 107+mta_posyOffset, tocolor(255, 255, 255, 255), 1.00, "default-bold", "left", "top", false, false, true, false, false)
...
function linkForumAccount()
	...
	forumLink.label[1] = guiCreateLabel(11, 23, 287, 17, "Nine Nine Login", false, forumLink.window[1])
	...
	forumLink.label[3] = guiCreateLabel(19, 71, 113, 15, "Usuario:", false, forumLink.window[1])
	forumLink.edit[1] = guiCreateEdit(20, 86, 278, 23, "", false, forumLink.window[1])
	forumLink.label[4] = guiCreateLabel(19, 118, 113, 15, "Contraseña:", false, forumLink.window[1])
...
function Characters_characterSelectionVisisble()
	...
	local text1= guiCreateLabel (0,0,1,1, "Reconectar", true, bLogout)
	...
	newCharacterButton_text = guiCreateLabel (0,0,1,1, "¡Crear Nuevo PJ!", true, newCharacterButton)
	...
	addEventHandler("onClientGUIClick", newCharacterButton, function()
		if source == newCharacterButton or source == newCharacterButton_text then
			if guiGetText(newCharacterButton_text) ~= "Verificando espacios de PJ..." then
				guiSetText(newCharacterButton_text, "Verificando espacios de PJ...")
...
function characterMouseOver()
	...
	if isCursorShowing( ) then
		...
		if ped and isElement(ped) then
			...
			text = string.upper("Click para Utilizar a "..name)
...
function characters_onSpawn(fixedName, adminLevel, gmLevel, location)
	...
	guiSetInputEnabled(false)
	showCursor(false)
	outputChatBox("Estás jugando como '" .. fixedName .. "'.", 0, 255, 0)
	outputChatBox("Si necesitas ayuda, contacta a un Staff via discord; en F1 tienes ayudas también.", 255, 194, 14)
	outputChatBox("Presiona F10 para acceder al menú de opciones, allí tendras tanto opciones de rendimiento como visuales.", 255, 194, 15)
	outputChatBox("Pásatelo bien, usa /guiarp para saber por dónde comenzar")
	characters_destroyDetailScreen()
