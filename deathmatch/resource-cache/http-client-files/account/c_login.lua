...
local loginTitleText = "Nine Nine Roleplay"
local old_screen
...
function defaultLoginText()
	loginTitleText = "Nine Nine Roleplay"
end
...
function showPasswordUpdate()
	showCursor(true)
	Window[1] = guiCreateWindow(0.3562,0.3997,0.2891,0.2383,"Advertencia:Seguridad de la cuenta",true)
		guiSetInputEnabled ( true)
		Label[1] = guiCreateLabel(0.0378,0.153,0.9324,0.2404,"Hemos detectado un posible flameo en tu cuenta.\nPara ayudarte a prevenir pérdida de datos,\nrecomendamos colocar una nueva contraseña en el campo especificado",true,Window[1])
		...
		Label[3] = guiCreateLabel(0.1216,0.6284,0.2784,0.1038,"Confirmar Contraseña:",true,Window[1])
