...
function getCarriedWeight(element)
	if not saveditems[element] then
		return 1000000, "Desconocido" -- Obviously too large to pick anything further up :o Yet if it fails that might even be good since we assume "if not loaded, can't happen"
	end
