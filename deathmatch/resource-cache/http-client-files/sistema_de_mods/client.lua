...
function addTab(tag)
	...
	guiGridListAddColumn( modGUI[modGUI[tag]], " Nombre", 0.35 )
	guiGridListAddColumn( modGUI[modGUI[tag]], "     Estado", 0.32 )
	guiGridListAddColumn( modGUI[modGUI[tag]], "  Peso", 0.1 )
end

addEventHandler("onClientResourceStart", resourceRoot,
	function()
		modGUI[1] = guiCreateWindow( 689, 285, 542, 483, "Panel Mods Lakeside", false )
		
		text1 = guiCreateLabel(22, 24, 498, 15, "Mod Lakeside: esto te ayudará a jugar en el servidor con MODS reemplazados.", false, modGUI[1])
		guiSetFont(text1, "default-bold-small")
        guiLabelSetColor(text1, 252, 202, 2)    
		
		text2 = guiCreateLabel(73, 40, 396, 15, "Si los jugadores tienen computadoras débiles, pueden desactivar MODS.", false, modGUI[1])
        guiSetFont(text2, "default-bold-small")
        guiLabelSetColor(text2, 178, 253, 0)    
		
		guiSetVisible(modGUI[1], false)
		guiWindowSetSizable(modGUI[1], false)
		guiWindowSetMovable(modGUI[1], false)

		modGUI[2] = guiCreateTabPanel ( 9, 62, 523, 375, false, modGUI[1] )
		
		modGUI[3] = guiCreateButton( 10, 448, 115, 23, "Activar", false, modGUI[1] )
        guiSetFont(modGUI[3], "default-bold-small")
        guiSetProperty(modGUI[3], "NormalTextColour", "FF83FE00")    
		
		modGUI[4] = guiCreateButton( 146, 448, 115, 23, "Desactivar", false, modGUI[1] )
		guiSetFont(modGUI[4], "default-bold-small")
		guiSetProperty(modGUI[4], "NormalTextColour", "FFFD1E00")
		
		modGUI[5] = guiCreateButton( 282, 448, 115, 23, "Activar todos", false, modGUI[1] )
		guiSetFont(modGUI[5], "default-bold-small")
		guiSetProperty(modGUI[5], "NormalTextColour", "FF83FE00")
		
		modGUI[6] = guiCreateButton( 418, 448, 115, 23, "Desactivar Todos", false, modGUI[1] )
		guiSetFont(modGUI[6], "default-bold-small")
		guiSetProperty(modGUI[6], "NormalTextColour", "FFFD1E00")
...
function refresh()
	...
	for i, v in pairs(mData) do
		...
		guiGridListSetItemText ( modGUI[ modGUI[ v[3] ] ], row, 3, ( fileExists("mods/"..v[3].."/"..i:lower()..".txd") and fileExists("mods/"..v[3].."/"..i:lower()..".dff") ) and "> Descargado <" or "> Sin Descargar <", false, false )
