...
function openRacesMenu()
	if (exports.integration:isPlayerAdmin(localPlayer)) or (exports.integration:isPlayerScripter(localPlayer)) or (exports.integration:isPlayerVehicleConsultant(localPlayer)) then
		...
		wSACMA = guiCreateWindow(X, Y, Width, Height, "Eventos de Carrera - LakesideRP", false)
		guiWindowSetSizable(wSACMA, false)

		-----------------[[ Positioning Options ]]-----------------
		lSACMA[1] = guiCreateLabel(14, 33, 369, 17, "Posición de Punto de Control: " .. (chkX or "N/A") .. ", " .. (chkY or "N/A") .. ", " .. (chkZ or "N/A"), false, wSACMA)
		lSACMA[2] = guiCreateLabel(14, 51, 154, 17, "Interior: " .. int, false, wSACMA)
		lSACMA[3] = guiCreateLabel(169, 51, 214, 17, "Dimensión: " .. dim, false, wSACMA)
		bSACMAgotopos = guiCreateButton(387, 40, 90, 23, "Ir a posición", false, wSACMA)
		guiSetFont(bSACMAgotopos, "default-bold-small")
		addEventHandler("onClientGUIClick", bSACMAgotopos, gotoCheckpointPosition, false)
		bSACMAsetpos = guiCreateButton(489, 40, 89, 23, "Aplicar posición", false, wSACMA)
		...
		-----------------[[ Checkpoint Options ]]------------------
		lSACMA[5] = guiCreateLabel(14, 98, 369, 17, "Alcance del Punto de Control: " .. chkRadius, false, wSACMA)
		bSACMAsetradius = guiCreateButton(393, 95, 179, 23, "Aplicar alcance", false, wSACMA)
		...
		-----------------[[ Laps Options ]]------------------------
		lSACMA[7] = guiCreateLabel(14, 136, 369, 17, "Número de vueltas: " .. (laps or "N/A"), false, wSACMA)
		bSACMAsetlaps = guiCreateButton(393, 133, 179, 23, "Config. Vueltas", false, wSACMA)
		...
		lSACMA[9] = guiCreateLabel(14, 174, 369, 17, "Corredores Actualmente: " .. #racers, false, wSACMA)

		gridSACMA = guiCreateGridList(12, 201, 563, 160, false, wSACMA)
		gridSACMAcol[1] = guiGridListAddColumn(gridSACMA, "ID", 0.1)
		gridSACMAcol[2] = guiGridListAddColumn(gridSACMA, "Veh (ID)", 0.1)
		gridSACMAcol[3] = guiGridListAddColumn(gridSACMA, "Nombre", 0.4)
		gridSACMAcol[4] = guiGridListAddColumn(gridSACMA, "Corredor Nº", 0.15)
		gridSACMAcol[5] = guiGridListAddColumn(gridSACMA, "Posicion", 0.25)
		for i = 1, #racers do
			if (isElement(racers[i])) then
				...
				guiGridListSetItemText(gridSACMA, row, gridSACMAcol[5], (racersInfo[racers[i]].finished or "Corriendo"), false, false)
			end
		end
		addEventHandler( "onClientGUIDoubleClick", gridSACMA, updateRacerGUI, false )
		
		bSACMAremracer = guiCreateButton(387, 171, 90, 23, "Quitar corredor", false, wSACMA)
		guiSetFont(bSACMAremracer, "default-bold-small")
		addEventHandler("onClientGUIClick", bSACMAremracer, removeRacer, false)
		
		bSACMAaddracer = guiCreateButton(488, 171, 90, 23, "Agregar corredor", false, wSACMA)
		...
		bSACMApreprace = guiCreateButton(12, 366, 179, 23, "Preparar Punto de Control", false, wSACMA)
		...
		bSACMAstartrace = guiCreateButton(204, 366, 179, 23, "Actualizar info", false, wSACMA)
		guiSetFont(bSACMAstartrace, "default-bold-small")
		guiSetEnabled(bSACMAstartrace, false)
		
		bSACMAclose = guiCreateButton(397, 366, 179, 23, "Cerrar", false, wSACMA)
...
addCommandHandler("eventocarreras", openRacesMenu, false, false)
