...
function showCKInfo(text, name)
	...
	ckInfoWindow = guiCreateWindow(ax, ay, 350, 200, name and ( "El Cadáver de (( " .. name .. " )) " ) or "Un Cadáver Desconocido.", false)
	...
	local cbutton = guiCreateButton(0.05, 0.85, 0.87, 0.1, "Cerrar", true, ckInfoWindow)
