alertTypes = {
	info = {"Info", "hot-dog/files/info.png", {0, 149, 217}, "files/bulle.wav"},
	error = {"Error", "hot-dog/files/error.png", {200, 50, 50}, "files/error.wav"},
	warning = {"Warning", "hot-dog/files/warning.png", {255, 128, 0}, "files/error.wav"}, 
}
...
function showInfobox(type, msg, msg2, imgPath, color)
	...
	local messageWidth = math.max(dxGetTextWidth(msg, 0.85, fonts.Roboto14), dxGetTextWidth(msg2 or "", 0.85, fonts.Roboto14)) + 20
	local tileWidth = iconSize + messageWidth
	
	infobox.tileWidth = tileWidth
	infobox.tileHeight = math.max(dxGetFontHeight(0.85, fonts.Roboto14) * (msg2 and 2 or 1) + 10, respc(40))
...
addEventHandler("onClientRender", getRootElement(),
	function ()
		...
		if infobox.message[2] then
			dxDrawText(infobox.message[1] .. "\n" .. infobox.message[2], x + infobox.tileHeight, y, x + infobox.tileWidth, y + infobox.tileHeight, tocolor(255, 255, 255, alpha * 255), 0.85, fonts.Roboto14, "center", "center", true)
		else
			dxDrawText(infobox.message[1], x + infobox.tileHeight, y, x + infobox.tileWidth, y + infobox.tileHeight, tocolor(255, 255, 255, alpha * 255), 0.85, fonts.Roboto14, "center", "center", true)
		end
