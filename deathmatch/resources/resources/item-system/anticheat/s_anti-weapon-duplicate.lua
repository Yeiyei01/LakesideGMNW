...
function isThisGunDuplicated(itemId, itemValue, fromPlayer)
	...
	if (row1+row2) > 1 then
		exports.global:sendMessageToAdmins("[ITEM SYSTEM] Arma duplicada detectada y borrada del jugador " ..(fromPlayer and exports.global:getPlayerName(fromPlayer) or "Unknown").. "." )
		return true
	end
	return false
end