local anims_list = {
	...
	['watchdogs'] = {'custom/watchdogs.ifp', true, price = 0, name = "Watch Dogs", engine = 1, disabled = 0},
	['gta4'] = {'custom/gta4.ifp', true, price = 0, name = "GTA IV", engine = 1, disabled = 0},
	['gta5'] = {'custom/gta5.ifp', true, price = 0, name = "GTA V", engine = 1, disabled = 0},
	['swat'] = {'custom/swat.ifp', true, price = 0, name = "SEB", engine = 1, disabled = 0},
	
	['custom_1'] = {'custom/custom_1.ifp', true, price = 0, name = "James Bond", engine = 1, disabled = 0}, -- Gang 1
	['custom_2'] = {'custom/custom_2.ifp', true, price = 0, name = "Tactica I", engine = 1, disabled = 0}, -- Gang 2
	['custom_3'] = {'custom/custom_3.ifp', true, price = 0, name = "Parkur", engine = 1, disabled = 0}, -- Parkour
	...
	['custom_6'] = {'custom/custom_6.ifp', true, price = 0, name = "Dev Animasyon Fiziği I", engine = 1, disabled = 0}, -- Project Awesome
	['custom_7'] = {'custom/custom_7.ifp', true, price = 0, name = "Mujer", engine = 1, disabled = 0}, -- Female Remaked
	['custom_8'] = {'custom/custom_8.ifp', true, price = 0, name = "Çete Animasyon Fiziği II", engine = 1, disabled = 0}, -- Gang 4
	['custom_9'] = {'custom/custom_9.ifp', true, price = 0, name = "Dev Animasyon Fiziği II", engine = 1, disabled = 0}, -- New Animations for GTA:SA
	...
	['custom_11'] = {'custom/custom_11.ifp', true, price = 0, name = "Tactico II", engine = 1, disabled = 0}, -- Gang 5
    	...
    	for index, value in pairs(anims_list) do
    		...
    		if value[2] == false then
	    		...
	    		for id, commandName in ipairs(value[3]) do
	    			...
	    			addCommandHandler("31313131313131313131313131",
	    				function(cmd)
...
addCommandHandler("313131313132222222",
	function(cmd, id)
		if isPedInVehicle(localPlayer) then return end
...
addCommandHandler("animpanel",
	function()
		...
		if getElementData(localPlayer, "loggedin") == 1 then
			...
			window = guiCreateWindow(0, 0, 549, 335, "Anim Panel", false)
