...
{
	-- Violent
	createObject(14871,1981.1654052734,-2485.4750976563,14.450757026672,0,0,0,1)
}

local col = createColSphere(1982.5302734375, -2483.3603515625, 13.606507301331, 50)
