...
function processCustomInterior(player, command, dimension, playerUsername, userId)
    ...
    exports.global:sendMessageToAdmins("[UCP] El jugador "..playerUsername.." ha subido un interior customizado para la propiedad ID#"..dimension..".")
	...
	loadDimension(tonumber(dimension), function (objectCount)
        ...
        exports.global:sendMessageToAdmins("[UCP] Cargando "..objectCount.." para el interior customizado propiedad ID#"..dimension)
	end)
end
...
addCommandHandler("reloadinterior", function (player, command, dimension)
	...
	if not dimension then
		outputChatBox("Syntax: /" .. command .. " [dimension] - Recargar objetos de los interiores personalizados.", player, 255, 255, 255)
	end

	loadDimension(dimension, function (objectCount)
		outputChatBox("Haz recreado " .. objectCount .. " objectos en la dimension " .. dimension .. ".", player, 100, 255, 100)
	end)
end, false, false)