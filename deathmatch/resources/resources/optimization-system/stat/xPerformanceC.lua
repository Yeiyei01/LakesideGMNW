...
local MED_CLIENT_CPU = 12 -- 5%
local MAX_CLIENT_CPU = 20 -- 10%
...
function resStatRender()
	...
	if #clientRows ~= 0 then
		...
		if #serverRows == 0 then
			dxDrawText("Client",sx-74,y-19,sx-74,y-19,tocolor(0,0,0,255),1, font,"center")
			dxDrawText("Client",sx-75,y-20,sx-75,y-20,tocolor(255,255,255,255),1, font,"center")
		else
			dxDrawText("Client",sx-234,y-19,sx-234,y-19,tocolor(0,0,0,255),1, font,"center")
			dxDrawText("Client",sx-235,y-20,sx-235,y-20,tocolor(255,255,255,255),1, font,"center")
		end
	...
	if #serverRows ~= 0 then
		...
		local y = sy/2-height/2
		dxDrawText("Server",sx-74,y-19,sx-74,y-19,tocolor(0,0,0,255),1, font,"center")
		dxDrawText("Server",sx-75,y-20,sx-75,y-20,tocolor(255,255,255,255),1, font,"center")
