...
local function getSectionFromName(section)
    local sections = {"Servicios", "Vehiculos", "Inmobiliaria", "Comunidad", "Trabajos", "Personales"}
...
local function transferBankFunds(player, advertisement)
    ...
    if factionId > 0 then
        ...
        exports.bank:addBankTransactionLog(-factionId, -SAN_FACTION_ID, 100, 2, "Ingresos Publicidad")
    ...
    exports.bank:giveBankMoney(exports.factions:getFactionFromID(SAN_FACTION_ID), 100)
    exports.bank:addBankTransactionLog(getElementData(player, "dbid"), -SAN_FACTION_ID, 100, 2, "Ingresos Publicidad")
