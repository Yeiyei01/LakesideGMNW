...
function newCharacter_create(characterName, characterDescription, race, gender, skin, height, weight, age, languageselected, month, day, location)
	...
	if (id) then --
		...
		-- ID CARD
		exports.global:giveItem( client, 152, characterName..";"..(gender==0 and "Hombre" or "Mujer")..";"..exports.global:numberToMonth(month).." "..exports.global:formatDate(day)..", "..year..";"..fingerprint)
		-- Briefcase
