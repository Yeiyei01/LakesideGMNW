...
function resourceStart(resource)
	setWaveHeight ( 0 )
	setGameType("Lakeside Roleplay")
	--setGameType("")
	setMapName("Los Santos")
	setRuleValue("Script Version", exports.global:getScriptVersion())
	setRuleValue("Author", "Lakeside RP")
	setRuleValue("Website", "https://discord.gg/Q9SbJeA9du")
...
function makeOwlName(thePlayer)
	setPlayerName(thePlayer, "Cargando.LakesideRP#"..tostring(math.random(0,9))..tostring(math.random(0,9))..tostring(math.random(0,9))..tostring(math.random(0,9)))
end
