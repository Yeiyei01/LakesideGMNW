...
function oduluVer() -- ödülün alınıp alınamaycağını ayarlar
	...
	outputChatBox("#007dfa[!]#90a3b6 Bonus Nine Nine RP: El codigo es #90a3b6[#ffffff"..komut.."#90a3b6] - usa /bonuspayday <Codigo> para reclamar tu premio.", r, g, b, true)
...
function odulGeriSayim()
	...
	outputChatBox("#28e000[!]#f8f8f8 Desafortunadamente, te perdiste el bono.", 255, 0, 0, true)	
end
...
addCommandHandler("bonuspayday", function(_,yazilan)
	if komut then
		if yazilan and yazilan == komut then
			...
			outputChatBox ("[!] #ffffffIngresaste un código incorrecto.", 255, 0, 0, true)
		end
	end	
end)
