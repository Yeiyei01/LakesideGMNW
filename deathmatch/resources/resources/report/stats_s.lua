...
function updateStaffReportCount( thePlayer, report )
	...
	if adminreports_saved >= reportsToAward then
		...
		exports.achievement:awardPlayer(thePlayer, false, "Has tomado "..reportsToAward.." reportes", gcToAward)
		exports.global:sendWrnToStaff(exports.global:getPlayerFullIdentity(thePlayer).." ha conseguido "..gcToAward.." GCs por completar "..reportsToAward.." reportes.", "ACHIEVEMENT")
	else
