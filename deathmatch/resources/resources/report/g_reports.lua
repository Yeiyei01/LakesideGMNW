...
reportTypes = {
 	[1] = {"Problema con otro jugador", {18, 17, 64, 15, 14, 16}, "JGR", 214, 6, 6, "Usa esta opción cuando tengas un problema con un jugador." },
	[2] = {"Problema con un Interior", {18, 17, 64, 15, 14, 16}, "INT", 255, 126, 0, "Usa esta opcion cuando tengas un problema con un interior." },
	[3] = {"Problema con un Item", {18, 17, 64, 15, 14, 16}, "ITM", 255, 126, 0, "Usa esta opción cuando necesites un item o algo relacionado con items." },
	[4] = {"Cuestiones generales", {30, 18, 17, 64, 15, 14, 16}, "SUP", 70, 200, 30, "Usa esto si tienes alguna duda." },
	[5] = {"Problemas relacionados con un vehiculo", {30, 18, 17, 64, 15, 14, 16}, "VEH", 255, 126, 0, "Usa esta opcion si tienes problemas con un vehiculo ." },
	[6] = {"Solicitud de venta/compra de vehiculo", {39, 43}, "VCT", 176, 7, 237, "Usa esta opcion si necesitas realizar una venta/compra de vehiculo a otro jugador." },
	[7] = {"Problemas de Script", {32}, "ScrT", 148, 126, 12, "Usa esta opción si has visto un problema de algun script" },
    [8] = {"Robo de Vehiculo", {14, 18, 17, 64, 15}, "VEH-BI", 255, 126, 0, "Usa esta opcion si te han robado el vehiculo."},
    [9] = {"Robo en interior", {14, 18, 17, 64, 15}, "INT-BI", 255, 126, 0, "Usa esta opcion si te han robado en un interior (tu casa)."},
	[10] = {"Problemas con un Mapeo", {44, 28}, "MAP", 0, 150, 190, "Usa esta opcion si viste un problema en un mapeo." }
}
...
function getReportInfo(row, element)
	...
	for k,v in ipairs(staff) do
		if v == 39 or v == 43 then
			...
			if vcount==0 then
				return false, "No hay miembros del VCT (Vehicle Control Team) conectados, contactalos via: https://discord.gg/Q9SbJeA9du"
		...
		elseif v == 32 then
			...
			if scount==0 then
				return false, "No hay miembros del ST (Scripting Team) conectados, contactalos via https://discord.gg/Q9SbJeA9du"
