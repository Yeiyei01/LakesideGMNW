...
drawScoreboard = function ()
	...
	local serverName = getElementData ( g_scoreboardDummy, "serverName" ) or "Nine Nine Roleplay | ES"
	local maxPlayers = getElementData ( root, "server:Slots" ) or 100
	...
	local strPlayerCount = "Usuarios: " .. tostring(#g_players) .. "/" .. tostring(maxPlayers) .. " (" .. math.floor(usagePercent + 0.5) .. "%)"
	...
	-- Draw the headers
	drawRowBounded ( "ID", "Nombre", "Horas", "Ping",
