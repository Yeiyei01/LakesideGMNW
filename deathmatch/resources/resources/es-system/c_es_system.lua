...
function showRespawnButton(victimDropItem)
	...
	bRespawn = guiCreateButton(x, y, width, height,"Reaparecer",false)
...
function getMedicalBill(amount, insurance, faction, issuedBy, date, rankName)
	...
	if faction == 164 then
		...
		local label5 = guiCreateLabel(20, 103, 140, 22, "Factura:", false, medicalBillWindow)
		...
		local label9 = guiCreateLabel(20, 191, 140, 22, "Emitido por:", false, medicalBillWindow)
		...
		local label5 = guiCreateLabel(20, 30, 140, 22, "Factura:", false, medicalBillWindow)
			guiSetFont(label5, "default-bold-small")
		...
		local label9 = guiCreateLabel(20, 118, 140, 22, "Emitido por:", false, medicalBillWindow)
			guiSetFont(label9, "default-bold-small")
	...
	if bg then
		local label1 = guiCreateLabel(40, 5, 170, 22, "FICHA MÉDICA", false, bg)
			guiSetFont(label1, "default-bold-small")
			guiLabelSetColor(label1, 0, 0, 0)

		local label2 = guiCreateLabel(40, 37, 170, 22, "Total de tasas: $ "..tostring(exports.global:formatMoney(amount)), false, bg)
			guiLabelSetColor(label2, 170, 0, 0)
			local label2_2 = guiCreateLabel(18, 32, 22, 22, "", false, bg)
				guiLabelSetColor(label2_2, 0, 0, 0)

		local label3 = guiCreateLabel(40, 54, 170, 22, "Seguros: $ "..tostring(exports.global:formatMoney(insurance)), false, bg)
		...
		local label4 = guiCreateLabel(40, 76, 170, 22, "TOTAL ADEUDADO: $ "..tostring(exports.global:formatMoney(amount-insurance)), false, bg)
			guiSetFont(label4, "default-bold-small")
			guiLabelSetColor(label4, 170, 0, 0)
			local label3_2 = guiCreateLabel(18, 76, 22, 22, "=", false, bg)
				guiLabelSetColor(label3_2, 0, 0, 0)
	else
		local label1 = guiCreateLabel(200, 30, 170, 22, "FICHA MÉDICA", false, medicalBillWindow)
			guiSetFont(label1, "default-bold-small")

		local label2 = guiCreateLabel(200, 62, 170, 22, "Total de tasas: $ "..tostring(exports.global:formatMoney(amount)), false, medicalBillWindow)

		local label3 = guiCreateLabel(200, 84, 170, 22, "Seguros: - $ "..tostring(exports.global:formatMoney(insurance)), false, medicalBillWindow)

		local label4 = guiCreateLabel(200, 106, 170, 22, "TOTAL ADEUDADO: $ "..tostring(exports.global:formatMoney(amount-insurance)), false, medicalBillWindow)
			guiSetFont(label4, "default-bold-small")
	end
	...
	addEventHandler("onClientGUIClick", b3, function()
		closeMedicalBillWindow()
		outputChatBox("Se negó a pagar la factura médica.", 255, 0, 0)
