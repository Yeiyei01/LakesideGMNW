...
function lsesPedHelp(pedName)
	exports['global']:sendLocalText(client, pedName.." dice: ¿De verdad? ¡Un momento!", 255, 255, 255, 10)
	exports['global']:sendLocalText(client, pedName.." [RADIO]: ¡Alguien necesita ayuda en la recepción del hospital!", 255, 255, 255, 10)
	for key, value in ipairs( exports.factions:getPlayersInFaction(2) ) do
		outputChatBox("[RADIO] Esto es despacho, tenemos un incidente, terminado.", value, 0, 183, 239)
		outputChatBox("[RADIO] Situación: ¡Alguien necesita ayuda !, cambio.  ((" .. getPlayerName(client):gsub("_"," ") .. "))", value, 0, 183, 239)
		outputChatBox("[RADIO] Ubicación: Hospital General Bluberry, en la recepción, al otro lado.", value, 0, 183, 239)
	end
end
...
function lsesPedAppointment(pedName)
	exports['global']:sendLocalText(client, pedName.." dice: Notificaré a quien pueda, por favor tome asiento mientras espera.", 255, 255, 255, 10)
	for key, value in ipairs( exports.factions:getPlayersInFaction(2) ) do
		outputChatBox("[RADIO] Recepción aquí, tenemos a alguien aquí para una cita, cambio. ((" .. getPlayerName(client):gsub("_"," ") .. "))", value, 0, 183, 239)
		outputChatBox("[RADIO] Ubicación: Hospital General Bluberry, en la recepción, al otro lado.", value, 0, 183, 239)
	end
end
