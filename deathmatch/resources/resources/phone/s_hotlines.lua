local easyHotlines = {
	...
	[311] = {
		name = "RSSD Non-Emergency", -- name of the hotline shown on the client-side
	...
	[511] = {
		name = "Riverside Municipal Government",
		order = 30,
		factions = { 3 },
		require_radio = true,
		operator = "Gov Employee",
		dialogue = {
			{ q = "Riverside Municipal Government. How can we help you?", as = "reason" },
	...
	[211] = {
		name = "Riverside Justice Department",
		operator = "Operator",
		factions = { 6 },
		require_radio = true,
		dialogue = {
