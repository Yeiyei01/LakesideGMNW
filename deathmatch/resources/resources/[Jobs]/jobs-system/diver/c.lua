...
addEventHandler("onClientMarkerHit", resourceRoot, function(hit)
  ...
  outputChatBox("Ждите....", 0, 255, 0)
  setElementFrozen(hit, true)
  setTimer(function()
    setElementFrozen(hit, false)
    outputChatBox("¡Tienes lo que necesitamos! Vuelve", 255, 255, 255)
...
addEventHandler("onClientMarkerHit", resourceRoot, function(hit)
  ...
  outputChatBox("¡Usted ha ganado "..hajs.."$!", 50, 200, 50)
  exports.global:giveMoney(hajs,1)
...
txd = engineLoadTXD("diver/swmyhp2.txd")
engineImportTXD(txd, 264)
dff = engineLoadDFF("diver/swmyhp2.dff")
