			...
			for i = 1, #tooltips do
				...
				if isInBox( cursorX, cursorY, ax, ax + iconW, ay, ay + iconH/2 ) then
					...
					if tooltips[i] == "adminonduty" then
						tooltip( cursorX, cursorY, "En servicio STAFF (ADM)", "Click para salir de servicio")
						if justClicked then
					...
					elseif tooltips[i] == "adminoffduty" then
						tooltip( cursorX, cursorY, "Fuera de servicio STAFF (ADM)", "Click para entrar en servicio")
						if justClicked then
					...
					elseif tooltips[i] == "gmonduty" then
						tooltip( cursorX, cursorY, "En servicio STAFF (MOD)", "Click para salir de servicio")
						if justClicked then
					...
					elseif tooltips[i] == "gmoffduty" then
						tooltip( cursorX, cursorY, "Fuera de servicio STAFF (MOD)", "Click para entrar en servicio")
						if justClicked then
					...
					elseif tooltips[i] == "nametag_on" then
						tooltip( cursorX, cursorY, "Nombre dorado activado", "Fecha de expiración: "..(getElementData(localPlayer, "donation:nametag:expiredate") or "Actualizando.."))
						if justClicked then
							triggerServerEvent("global:toggleGoldenNametag", localPlayer)
							playToggleSound()
						end
					elseif tooltips[i] == "nametag_off" then
						tooltip( cursorX, cursorY, "Nombre dorado desactivado", "Fecha de expiración: "..(getElementData(localPlayer, "donation:nametag:expiredate") or "Actualizando.."))
						if justClicked then
							triggerServerEvent("global:toggleGoldenNametag", localPlayer)
							playToggleSound()
						end
					elseif tooltips[i] == "lifeTimeNameTag_on" then
						tooltip( cursorX, cursorY, "Nombre dorado activado", "Fecha de expiración: Nunca")
						if justClicked then
							triggerServerEvent("global:toggleGoldenNametag", localPlayer)
							playToggleSound()
						end
					elseif tooltips[i] == "lifeTimeNameTag_off" then
						tooltip( cursorX, cursorY, "Nombre dorado desactivado", "Fecha de expiración: Nunca")
						if justClicked then
							triggerServerEvent("global:toggleGoldenNametag", localPlayer)
							playToggleSound()
						end
					...
					elseif tooltips[i] == "pdduty" then
						tooltip( cursorX, cursorY, "En servicio SHERIFF", "Click para salir de servicio")
						if justClicked then
					...
					elseif tooltips[i] == "jobduty" then
						tooltip( cursorX, cursorY, "Placa de Trabajo activada")
						if justClicked then
							triggerServerEvent("item-system:toggleBadge", localPlayer, localPlayer, exports['item-system']:getBadges(), 64 , "Test")
							playToggleSound()
						end
					...
					elseif tooltips[i] == 122 or tooltips[i] == 123 or tooltips[i] == 124 or tooltips[i] == 125 or tooltips[i] == 135 or tooltips[i] == 136 then
						tooltip( cursorX, cursorY, "Tienes puesto una Bandana", "Click para quitártela")
						if justClicked then
					...
					elseif tooltips[i] == "report_panel_mod:0" then
						tooltip( cursorX, cursorY, "Modo Panel de Reportes - OFF", "Click para activar.")
						if justClicked then
					...
					elseif tooltips[i] == "report_panel_mod:1" then
						tooltip( cursorX, cursorY, "Modo Panel de Reportes - 1", "Click para cambiar.")
						if justClicked then
					...
					elseif tooltips[i] == "report_panel_mod:2" then
						tooltip( cursorX, cursorY, "Modo Panel de Reportes - 2", "Click para cambiar.")
						if justClicked then
					...
					elseif tooltips[i] == "report_panel_mod:3" then
						tooltip( cursorX, cursorY, "Modo Panel de Reportes - 3", "Click para desactivar.")
						if justClicked then
					...
					elseif tooltips[i] == "armour" then
						tooltip( cursorX, cursorY, "Armadura: "..math.floor(getPedArmor(localPlayer)) .. "%")		
					--STYLE 
					elseif tooltips[i] == "settings:hud:tagmode:newstyle:on" then
						tooltip( cursorX, cursorY, "HUD Activado", "Click para Ocultar.")
						if justClicked then
					...
					elseif tooltips[i] == "settings:hud:tagmode:newstyle:off" then
						tooltip( cursorX, cursorY, "HUD Desactivado", "Click para Mostrar.")
						if justClicked then
					...
					elseif tooltips[i] == "settings:hud:walkingstyle" then
						tooltip( cursorX, cursorY, "Estilo de Caminar: "..getPedWalkingStyle(localPlayer), "Click para Cambiarlo.")
						if justClicked then
					...
					elseif tooltips[i] == "settings:hud:autopark:on" then
						tooltip( cursorX, cursorY, "Guardado automático (lugar de aparición) para vehículo - Activado", "Click para desactivar.")
						if justClicked then
					...
					elseif tooltips[i] == "settings:hud:autopark:off" then
						tooltip( cursorX, cursorY, "Guardado automático (lugar de aparición) para vehículo - Desactivado", "Click para activar.")
						if justClicked then
					...
					elseif tooltips[i][1] == "deaglemode" then
						...
						if mode == 0 then
							tooltip( cursorX, cursorY, "Modo Tazer", "Click para cambiar al modo Letal")
						elseif mode == 1 then
							tooltip( cursorX, cursorY, "Modo Letal", "Click para cambiar al modo Radar")
						elseif mode == 2 or mode == 1 then
							tooltip( cursorX, cursorY, "Modo Radar", "Click para cambiar al modo Tazer")
						end
						if justClicked then
					...
					elseif tooltips[i][1] == "shotgunmode" then
						...
						if mode == 0 then
							tooltip( cursorX, cursorY, "Modo No-Letal", "Click para cambiar al modo letal")
						elseif mode == 1 then
							tooltip( cursorX, cursorY, "Modo Letal", "Click para cambiar al modo no-letal")
						end
						if justClicked then
							exports["pd-system"]:switchMode()
							playToggleSound()
					...
					elseif tooltips[i] == "settings:hud:head_turning:0" then
						tooltip( cursorX, cursorY, "Mover cabeza desactivado", "Click para activar.")
						if justClicked then
					...
					elseif tooltips[i] == "settings:hud:head_turning:1" then
						tooltip( cursorX, cursorY, "Mirando a los elementos cercanos.", "Click para cambiar.")
						if justClicked then
					...
					elseif tooltips[i] == "settings:hud:head_turning:2" then
						tooltip( cursorX, cursorY, "Mirando donde la cámara.", "Click para cambiar.")
						if justClicked then
					...
					elseif tooltips[i] == "settings:hud:togad:on" then
						tooltip( cursorX, cursorY, "Anuncios activados", "Click para desactivar.")
						if justClicked then
							triggerServerEvent("chat:togad", localPlayer,localPlayer)
							playToggleSound()
						end
					elseif tooltips[i] == "settings:hud:togad:off" then
						tooltip( cursorX, cursorY, "Anuncios desactivados", "Click para activar.")
						if justClicked then
							triggerServerEvent("chat:togad", localPlayer,localPlayer)
							playToggleSound()
						end
					...
					elseif tooltips[i] == "settings:hud:togpm:on" then
						tooltip( cursorX, cursorY, "Mensajes privados activados", "Click para ignorar los mensajes privados.")
						if justClicked then
							triggerServerEvent("chat:togpm", localPlayer,localPlayer)
							playToggleSound()
						end
					elseif tooltips[i] == "settings:hud:togpm:off" then
						tooltip( cursorX, cursorY, "Mensajes privados desactivados", "Click para recibir mensajes privados.")
						if justClicked then
							triggerServerEvent("chat:togpm", localPlayer,localPlayer)
							playToggleSound()
						end
					...
					elseif tooltips[i] == "settings:hud:togdon:on" then
						tooltip( cursorX, cursorY, "Chat de donador activado", "Click para ignorar los mensajes de donador.")
						if justClicked then
							exports.donators:updatePerkValue(localPlayer, 10, 0)
							playToggleSound()
						end
					elseif tooltips[i] == "settings:hud:togdon:off" then
						tooltip( cursorX, cursorY, "Chat de donador desactivado", "Click para recibir mensajes de donador.")
						if justClicked then
					...
					elseif tooltips[i] == "settings:hud:hidden_scoreboard:on" then
						tooltip( cursorX, cursorY, "Te has oculto de la lista de jugadores", "Click para verte.")
						if justClicked then
							exports.donators:updatePerkValue(localPlayer, 12, 0)
							playToggleSound()
						end
					elseif tooltips[i] == "settings:hud:hidden_scoreboard:off" then
						tooltip( cursorX, cursorY, "Te has puesto visible en la lista de jugadores", "Click para ocultarte.")
						if justClicked then
					...
					elseif tooltips[i] == "settings:hud:hidden_username:on" then
						tooltip( cursorX, cursorY, "Tu nombre de usuario ha sido ocultado.", "Click para verlo.")
						if justClicked then
							exports.donators:updatePerkValue(localPlayer, 9, 0)
							playToggleSound()
						end
					elseif tooltips[i] == "settings:hud:hidden_username:off" then
						tooltip( cursorX, cursorY, "Tu nombre de usuario se ha revelado.", "Click para ocultarlo.")
						if justClicked then
							exports.donators:updatePerkValue(localPlayer, 9, 1)
							playToggleSound()
						end
					elseif tooltips[i] == "settings:hud:opm" then
						tooltip( cursorX, cursorY, "Enviar mensajes privados fuera de conexión.", "Click para enviar. O puedes usar /opm [Nombre de Usuario] [Mensaje]")
						if justClicked then
							executeCommandHandler("opm")
							playToggleSound()
						end
					elseif tooltips[i] == "settings:hud:ads" then
						tooltip( cursorX, cursorY, "Crear una publicidad.", "Click para crear. O puedes usar /ads")
						if justClicked then
							executeCommandHandler('ads')
							playToggleSound()
						end
					elseif tooltips[i] == "firemode:auto" then
						tooltip( cursorX, cursorY, "Modo de disparo: Automático", "Click para cambiar. O puedes presionar 'N'")
						if justClicked then
							triggerEvent("weapon:firemode_switchFireMode", localPlayer)
							playToggleSound()
						end
					elseif tooltips[i] == "firemode:semi" then
						tooltip( cursorX, cursorY, "Modo de disparo: Semi-automático", "Click para cambiar. O puedes presionar 'N'")
						if justClicked then
							triggerEvent("weapon:firemode_switchFireMode", localPlayer)
							playToggleSound()
						end
					elseif justClicked then
						outputDebugString('Clickeaste ' .. tooltips[i])
					end
				end
			end
			...
			for i = 1, #tooltips_bottom do
				...
				if isInBox( cursorX, cursorY, bx, bx + iconW, by, by + iconH/2 ) then
					...
					elseif tooltips_bottom[i] == "settings:hud:handbrake:on" then
						if isBike then
							tooltip( cursorX, cursorY, "Pata de moto - ON", "'G' o /kickstand")
						else
							tooltip( cursorX, cursorY, "Freno de mano - ON", "'G' o /handbrake")
						end
						if justClicked then
					...
					elseif tooltips_bottom[i] == "settings:hud:handbrake:off" then
						if isBike then
							tooltip( cursorX, cursorY, "Pata de moto - OFF", "'G' o /kickstand")
						else
							tooltip( cursorX, cursorY, "Freno de mano - OFF", "'G' o /handbrake")
						end
						if justClicked then
							exports['realism']:doHandbrake()
							playToggleSound()
					...
					elseif tooltips_bottom[i] == "hud:carlock:off" then
						tooltip( cursorX, cursorY, "Puertas desbloqueadas", "'K' o /lock")
						if justClicked then
							triggerServerEvent('togLockVehicle', localPlayer, localPlayer)
							playToggleSound()
						end
					...
					elseif tooltips_bottom[i] == "settings:hud:speedo:off" then
						tooltip( cursorX, cursorY, "Modo velocímetro - OFF", " ")
						if justClicked then
					...
					elseif tooltips_bottom[i] == "settings:hud:speedo:kmh" then
						tooltip( cursorX, cursorY, "Modo velocímetro - KM/H", " ")
						if justClicked then
					...
					elseif tooltips_bottom[i] == "settings:hud:speedo:mph" then
						tooltip( cursorX, cursorY, "Modo velocímetro - MPH", " ")
						if justClicked then
					...
					elseif tooltips_bottom[i] == 'belt:on' then
						tooltip( cursorX, cursorY, 'Te has puesto el cinturón.', "'C' o /belt")
						if justClicked then
							triggerServerEvent('realism:seatbelt:toggle', localPlayer, localPlayer)
							playToggleSound()
						end
					elseif tooltips_bottom[i] == 'belt:off' then
						tooltip( cursorX, cursorY, 'Te has quitado el cinturón.', "'C' o /belt")
						if justClicked then
							triggerServerEvent('realism:seatbelt:toggle', localPlayer, localPlayer)
							playToggleSound()
						end
					...
					elseif tooltips_bottom[i] == 'windowstat:up' then
						tooltip( cursorX, cursorY, 'Ventanas arriba.', "'X' o /togwindow")
						if justClicked then
							triggerServerEvent('vehicle:togWindow', localPlayer)
							playToggleSound()
						end
					elseif tooltips_bottom[i] == 'windowstat:down' then
						tooltip( cursorX, cursorY, 'Ventanas bajas.', "'X' o /togwindow")
						if justClicked then
							triggerServerEvent('vehicle:togWindow', localPlayer)
							playToggleSound()
						end
					...
					elseif tooltips_bottom[i] == 'cc:on' then
						tooltip( cursorX, cursorY, 'Modo crucero activado.', "'pause' o /cc")
						if justClicked then
							triggerEvent('realism:togCc', localPlayer)
							playToggleSound()
						end
					elseif tooltips_bottom[i] == 'cc:off' then
						tooltip( cursorX, cursorY, 'Modo crucero desactivado.', "'pause' o /cc")
						if justClicked then
							triggerEvent('realism:togCc', localPlayer)
							playToggleSound()
						end
					...
					elseif tooltips_bottom[i] == "settings:hud:mdc" then
						tooltip( cursorX, cursorY, "Mobile Digital Computer", "Click para abrir.")
						if justClicked then
...
function fpsFunction( command, limit ) -- First define the function
  if limit and tonumber(limit) and tonumber(limit) >= 25 and tonumber(limit) <=60 then 
    ...
    if setFPSLimit ( limit ) then -- Set the fps. 
    	outputChatBox("FPS limitados a: "..limit..".")
    end
else
	outputChatBox("SYNTAX: /"..command.." [25~60] - Limita tus FPS.")
  end
end 
