...
--[[
{
	[1] = {"grotti", "Riverside Cars"},
	[2] = {"JeffersonCarShop", "Riverside Motos"},
...
--	Desactivado por Ale	if isElement(edits[7]) then
--			-- STOCK
...
--				guiSetText(labels[7], "Spawn Rate (OK!):")
--				guiLabelSetColor(labels[8], 0, 255,0)
--			else
--				guiSetText(labels[7], "Spawn Rate (Invalid!):")
