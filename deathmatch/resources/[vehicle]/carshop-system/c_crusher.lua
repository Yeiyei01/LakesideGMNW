...
addEventHandler('crusher:show', root,
	function(price)
		...
		guiCreateLabel(20, 15, windowWidth - 40, 16, 'Estamos a punto de desguazar su vehículo (( borrar ))', false, window)
		guiSetFont(guiCreateLabel(40, 40, windowWidth - 40, 16, exports.global:getVehicleName(source), false, window), 'default-bold-small')
		guiSetFont(guiCreateLabel(40, 65, windowWidth - 40, 16, 'Matricula: ' .. tostring(getElementData(source, 'dbid')), false, window), 'default-bold-small')
		guiSetFont(guiCreateLabel(40, 90, windowWidth - 40, 16, 'Por $' .. exports.global:formatMoney(price), false, window), 'default-bold-small')

		local accept = guiCreateButton(10, 110, windowWidth / 2 - 15, 40, "Sí, desguazalo por favor.", false, window)
		...
		local nope = guiCreateButton(windowWidth / 2 + 5, 110, windowWidth / 2 - 15, 40, "No, quiero quedarme mi vehiculo.", false, window)
