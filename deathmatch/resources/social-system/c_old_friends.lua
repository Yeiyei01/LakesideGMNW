...
function askAcceptFriend()
	...
	local lQuestion = guiCreateLabel(0.05,0.25,0.9,0.3,getPlayerName(source):gsub("_", " ") .. " quiere agregarte a su lista de amigos. ¿Quieres aceptar esta solicitud??",true,wConfirmFriendRequest)
	guiLabelSetHorizontalAlign (lQuestion,"center",true)
	bButtonYes = guiCreateButton(0.1,0.65,0.37,0.23,"Si",true,wConfirmFriendRequest)
