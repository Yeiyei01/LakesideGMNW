...
function friskShowItems(player)
	...
	triggerClientEvent(source, "friskShowItems", player)
...
function unrestrainPlayer(player, restrainedObj)
	...
	outputChatBox("Has sido liberado por " .. username:gsub("_", " ") .. ".", player)
	outputChatBox("te quitaste" .. targetPlayerName:gsub("_", " ") .. "'s restricciones.", source)
...
function blindfoldPlayer(player)
	...
	outputChatBox("Has sido vendado por " .. username .. ".", player)
	outputChatBox("tienes los ojos vendados" .. targetPlayerName .. ".", source)
...
function removeblindfoldPlayer(player)
	...
	outputChatBox("Le han quitado la venda de los ojos por " .. username .. ".", player)
	outputChatBox("te quitaste " .. targetPlayerName .. "'la venda de los ojos.", source)
...
function stabilizePlayer(player)
	...
	if found then
		...
		outputChatBox("Has sido estabilizado por " .. username .. ".", player)
		outputChatBox("te estabilizaste " .. targetPlayerName .. ".", source)
