...
torchertrpermissie1memo = guiCreateMemo(0.01,0.1,0.7,0.8,"Hola, necesito que coloques antorchas para que los leñeros puedan ver durante la noche, podrias?",true,torchertrpermissie1window)
...
--local blip = createBlip(-624.89514160156, -82.085350036621, 66.078125, 56, 0, 0, 0, 0, 0, 0, 250)
...
torchertrpermissie1marker = createMarker(-624.89514160156, -82.085350036621, 66.078125,"corona",1.5,255,0,0)
torchertrpermissie1theMarker = createMarker(-624.89514160156, -82.085350036621, 66.078125,"corona",2.5,255,0,0)
...
function(p) if p == lp then
	...
	setElementPosition(torchertrpermissie1theMarker,-624.89514160156, -82.085350036621, 66.078125)
	...
	outputChatBox("Usted gana #00FF00 $"..tostring(amount).."#FFFFFF por colocar una antorcha",255,255,255,true) 
...
bunfvsddfny = createPed ( 220, -624.89514160156, -82.085350036621, 66.078125 )
setElementHealth(bunfvsddfny , 1000000000)
setPedRotation ( bunfvsddfny , 300 )
setPedAnimation ( bunfvsddfny , "GHANDS", "gsign5", -1)
setElementFrozen(bunfvsddfny ,true)

torchssd = createObject ( 3461, x, y, z, 0, 0, 0 )