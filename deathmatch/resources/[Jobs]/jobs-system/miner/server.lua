...
local First2 = createMarker ( 618.5, 890.9, -37.1, "cylinder", 1.5, 255, 255, 0, 170 )
local First = createMarker ( 636.2, 857.9, -41.1, "cylinder", 1.5, 255, 255, 0, 170 )
...
function MarkerHit( hitElement, matchingDimension ) -- define MarkerHit function for the handler  
				setElementData(hitElement, "Occupation", "Iron Miner")
				setPlayerNametagColor ( hitElement, 222, 255, 4)
				outputChatBox ( "Ahora eres un minero.", hitElement, 0, 255, 0, true )
...
local playerWeapon = giveWeapon(source,6,0,true)
setPedAnimation(hitElement , "CHAINSAW", "WEAPON_csawlo", -1, false, false, false, false)
s1 = setTimer ( function()
				outputChatBox ( "Jefe Minero: Lleva el hierro a la procesadora", hitElement, 0, 255, 0, true )
...
local myNumber = math.random(50,150)
...
s2 = setTimer ( function()
				outputChatBox ( "Jefe Minero: Muy bien... aquí tienes tu dinero por el buen trabajo... ve a coger más hierro", hitElement, 0, 255, 0, true )
				exports.global:giveMoney ( hitElement, myNumber ) --give the player money according to the amount
...
outputChatBox ( "Has dejado de ser minero", thePlayer, 255, 0, 0, true )
