function mixDrugs(drug1, drug2, drug1name, drug2name)
	...
	if (given) then
		outputChatBox("Mezclaste '" .. drug1name .. "' y '" .. drug2name .. "' para formar '" .. drugName .. "'", client)
		exports.global:sendLocalMeAction(client, "mezcla algunos productos químicos.")
	else
		outputChatBox("No tiene suficiente espacio para mezclar estos productos químicos.", client, 255, 0, 0)
